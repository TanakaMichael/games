...
class TMino(Blocks):
    def __init__(self, name="Block", active=True, parent=None, network_id=None, steam_id=None):
        ...
        block1 = self.add_child(Block("Block1", parent=self, position=(-1, 0)))
        block2 = self.add_child(Block("Block2", parent=self, position=(1, 0)))
        block3 = self.add_child(Block("Block3", parent=self, position=(0, 1)))
